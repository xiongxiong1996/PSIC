...
from psic.utils.lane import Lane
from psic.models.losses.focal_loss import FocalLoss
from psic.models.losses.accuracy import accuracy
from psic.ops import nms

from psic.models.utils.roi_gather import ROIGather, LinearModule
from psic.models.utils.seg_decoder import SegDecoder
from psic.models.utils.dynamic_assign import assign
from psic.models.losses.lineiou_loss import liou_loss
...
class CLRHead(nn.Module):
    ...
    def forward(self, x, **kwargs):
        ...
        if self.training:
            ...
            return output,self.loss(output, kwargs['batch'])
