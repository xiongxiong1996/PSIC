...
def parse_args():
    ...
    parser.add_argument('--config',type=str, default='./configs/psic/resnet18_tusimple.py', help='train config file path')
    ...
    parser.add_argument('--gpus', nargs='+', type=str, default='0,1') # 测试GPU选择
