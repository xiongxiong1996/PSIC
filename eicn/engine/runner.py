...
from eicn.models.registry import build_net
from .registry import build_trainer, build_evaluator
from .optimizer import build_optimizer
from .scheduler import build_scheduler
from eicn.datasets import build_dataloader
from eicn.utils.recorder import build_recorder
from eicn.utils.net_utils import save_model, load_network, resume_network
...
class Runner(object):
    def __init__(self, cfg):
        ...
        device_ids=range(self.cfg.gpus)
        print(device_ids)
    ...
    def loop_val(self,pth_file):
        # load_network(self.net, self.cfg.load_from, finetune_from=self.cfg.finetune_from, logger=self.recorder.logger)
        load_network(self.net, pth_file)
        self.validate()